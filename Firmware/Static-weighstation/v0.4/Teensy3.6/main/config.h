...
const u1_t PROGMEM APPEUI[8] = { 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 };

// Device unique identifier (Format = LSB)
const u1_t PROGMEM DEVEUI[8] = { 0x51, 0x58, 0x04, 0xD0, 0x7E, 0xD5, 0xB3, 0x70 };

// APP-KEY (Sensitive - Remove if going public) (Format = MSB)
const u1_t PROGMEM APPKEY[16] = { 0xF5, 0x07, 0xB7, 0x41, 0xF1, 0x7D, 0x47, 0x8C, 0x84, 0x93, 0x73, 0x8F, 0x24, 0xB2, 0x54, 0xCB };
