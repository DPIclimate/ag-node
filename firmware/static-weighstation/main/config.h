...
/**
SD-card raw filename. Must have a .txt file extension
*/
...
/**
SD-card parameters filename. Must have a .txt file extension
*/
...
@todo Need to implement the OneWire dev on pin 37
*/
#ifndef ONE_WIRE_BUS
